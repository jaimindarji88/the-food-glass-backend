...
const foodDatabase = function(foodID)
{
    ...
    axios.get('https://api.nal.usda.gov/ndb/nutrients/?format=json&api_key=LUITmEEltJMaq6s75hXa1SGJIiWAhrn1MVKIikZH&nutrients=205&nutrients=204&nutrients=208&nutrients=269&ndbno=' + foodID).then(
        function(response){
